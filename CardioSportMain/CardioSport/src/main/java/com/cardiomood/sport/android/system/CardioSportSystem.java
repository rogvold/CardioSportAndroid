...
import com.cardiomood.sport.android.client.json.*;
...
public class CardioSportSystem {
    ...
    public void init() {
        try {
            ...
            cardioSportService.setEmail(pref.getString(ConfigurationManager.USER_EMAIL_KEY, true));
            cardioSportService.setPassword(pref.getString(ConfigurationManager.USER_PASSWORD_KEY, true));
